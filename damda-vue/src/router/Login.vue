    ...
    <v-row no-gutters>
      ...
      <v-col cols="12" sm="6">
        <v-card class="pa-2" outlined tile>
          ...
          <v-col>
            <v-text-field label="Email" :rules="emailRules" outlined height="5px"></v-text-field>
          </v-col>
          <v-col>
            <v-text-field label="Password" :rules="[passwordRules.required, passwordRules.min,]" outlined
