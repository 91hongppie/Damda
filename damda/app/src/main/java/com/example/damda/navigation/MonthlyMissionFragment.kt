...
class MonthlyMissionFragment: Fragment() {
    override fun onCreateView(
        ...
        view.rv_mission.adapter = MissionAdapter(missionList, context,this@MonthlyMissionFragment)
        missionService.requestMission("JWT $jwt", user_id, 2).enqueue(object: Callback<Missions> {
